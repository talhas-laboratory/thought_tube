...
class ActiveStateContinuityRolloutTestCase(unittest.TestCase):
    ...
    def test_release_runtime_keeps_continuity_disabled_until_cutover(self) -> None:
        ...
        self.assertFalse(active_state["continuity_v1"])
        self.assertEqual(active_state["rollout"]["bridge"], "legacy")
        self.assertFalse(release_runtime["disclosure"]["receipts"]["persistent_receipts_v1"])
