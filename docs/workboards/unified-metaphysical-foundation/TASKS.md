...
| `UMF-SHAPE-001-QUALITY-INSTANCE-REFINEMENT` | backlog | unassigned | Model QualityInstance and refinement lineage | not_required |
| `UMF-SHAPE-002-COMPOSITION-RECURSIVE-SYSTEMHOOD` | backlog | unassigned | Model composition, boundaries, and recursive systemhood | not_required |
| `UMF-SHAPE-003-ROLE-ASSIGNMENT-INFLUENCE` | backlog | unassigned | Model contextual roles and influence | not_required |
