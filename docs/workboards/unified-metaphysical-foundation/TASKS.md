...
| `UMF-T10-07-SHAPE-RETRIEVAL` | backlog | unassigned | T10-07 Shape-aware retrieval repair | not_required |
| `UMF-T10-09-TEMPORAL-REVISION` | review | unassigned | T10-09 Temporal / revision model | not_required |
| `UMF-T10-14-FIRST-BENCHMARK` | backlog | unassigned | T10-14 First comparative quality benchmark | not_required |
...
| `UMF-T10-WAVE-03-STRUCTURAL-INTEL` | ready | unassigned | Wave 3: Pattern/AntiMatch, retrieval repair, first benchmark | not_required |
