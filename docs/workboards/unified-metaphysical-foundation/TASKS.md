...
| `UMF-T10-12-AUTH-PRIVACY` | backlog | unassigned | T10-12 Authorization privacy poisoning | not_required |
| `UMF-T10-13-CONCURRENCY` | backlog | unassigned | T10-13 Multi-agent concurrency conflicts | not_required |
| `UMF-T10-14-FIRST-BENCHMARK` | review | unassigned | T10-14 First comparative quality benchmark | not_required |
| `UMF-T10-17-AGENT-HARNESS` | backlog | unassigned | T10-17 Coherent agent harness | not_required |
| `UMF-T10-18-SHAPE-INSPECTOR` | backlog | unassigned | T10-18 Inspectable Shapes and provenance | not_required |
...
| `UMF-T10-WAVE-04-SAFE-AGENT-USE` | in-progress | unassigned | Wave 4: safe disclosure activation and agent harness | not_required |
