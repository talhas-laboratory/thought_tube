...
| `UMF-T10-05-INDEX-CONTRACTS` | backlog | unassigned | T10-05 Index / retrieval contracts | not_required |
| `UMF-T10-09-TEMPORAL-REVISION` | backlog | unassigned | T10-09 Temporal / revision model | not_required |
...
| `UMF-T10-WAVE-02-CORPUS-OCEAN` | ready | foundation-lead | Wave 2: governed corpus ocean, indexes, and revision | not_required |
