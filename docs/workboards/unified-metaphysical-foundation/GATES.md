...
- The governing framework sections and invariants are cited.
- Historical-to-canonical migration impact is recorded.
- Source and derived layers remain separate.
- No new kernel primitive is introduced without a versioned framework amendment.
- A task that touches personal records includes privacy, reset, expiry, and consent behavior.
- A task that touches execution preserves the descriptive-to-operational compilation barrier.
